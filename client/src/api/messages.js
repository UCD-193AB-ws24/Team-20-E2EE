...
export const getArchivedChatHistory = async (senderUid, recipientUid) => {
  try {
    const response = await fetch(`${BACKEND_URL}/api/message/archive?senderUid=${senderUid}&recipientUid=${recipientUid}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
